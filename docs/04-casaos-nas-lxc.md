...
Para la gestión de archivos en red (NAS) y el despliegue de microservicios como Immich y Nextcloud, se optó por un entorno **Docker** gestionado gráficamente mediante **CasaOS**. El objetivo es maximizar la eficiencia del Intel i3 mediante el uso de un Contenedor Linux (LXC) sin privilegios, permitiendo una asignación dinámica de recursos.
...
**Parámetros clave:**
* **Storage (rootfs):** `local-lvm` (8 GB SSD para el sistema operativo).
* **Red:** IP estática `192.168.0.51`.
* **Seguridad:** Unprivileged container = Yes.

![Resumen de creación del LXC](../images/Captura%20desde%202026-04-01%2000-17-41.png)
...
![Verificación de montaje del disco de 2TB](../images/Captura%20desde%202026-04-01%2000-28-36.png)
...
![Inicio de instalación de CasaOS](../images/Captura%20desde%202026-04-01%2000-29-37.png)
...
![Verificación de servicios activos](../images/Captura%20desde%202026-04-01%2000-39-22.png)
...
![Dashboard de administración de CasaOS](../images/Captura%20desde%202026-04-01%2000-42-02.png)
