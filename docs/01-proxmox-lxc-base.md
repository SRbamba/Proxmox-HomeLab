...
![Resumen de confirmación del LXC](../images/Captura%20desde%202026-03-31%2000-07-52.png)
...
![Configuración de Interfaz de Red](../images/Captura%20desde%202026-03-31%2000-07-12.png)
...
![Terminal de primer inicio](../images/Captura%20desde%202026-03-31%2000-18-15.png)
...
En la parte inferior de la interfaz, se puede observar el historial de tareas donde se confirma que el aprovisionamiento de los discos y la red finalizó con estado **OK**.

![Historial de Tareas de Proxmox](../images/Captura%20desde%202026-03-31%2000-34-41.png)

---
**Siguiente paso:** [02-network-vpn.md](02-network-vpn.md)
